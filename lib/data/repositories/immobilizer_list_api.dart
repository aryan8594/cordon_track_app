...
class ImmobilizerListRepository  {
      final Ref ref;
      ImmobilizerListRepository(this.ref);
  Future<ImmobilizerListModel?> fetchImmobilizerListData() async {
    ...
    if (response.statusCode == 200) {
      log("Immobilizer List Data fetched");
      final jsonData = jsonDecode(response.body);
      return ImmobilizerListModel.fromJson(jsonData);
    } else {
